...
urlpatterns = [
    ...
    path('stats/', views.practice_stats, name='practice-stats'),
    path('subject-stats/', views.subject_stats, name='subject-stats'),
    path('weak-knowledge-points/', views.weak_knowledge_points, name='weak-knowledge-points'),
